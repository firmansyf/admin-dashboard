...
export function LayoutControllerProvider({children}: Props) {
  const initialState = {
    openSidenav: false,
    sidenavColor: 'dark',
    sidenavType: 'white',
...
export const setOpenSidenav = (dispatch: any, value: any) => dispatch({type: 'OPEN_SIDENAV', value})
export const setSidenavType = (dispatch: any, value: any) => dispatch({type: 'SIDENAV_TYPE', value})
export const setSidenavColor = (dispatch: any, value: any) =>
  dispatch({type: 'SIDENAV_COLOR', value})
export const setTransparentNavbar = (dispatch: any, value: any) =>
  dispatch({type: 'TRANSPARENT_NAVBAR', value})
export const setFixedNavbar = (dispatch: any, value: any) => dispatch({type: 'FIXED_NAVBAR', value})
