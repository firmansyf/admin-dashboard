...
export default function CheckTable() {
  ...
  const [filteredData, setFilteredData] = useState<any>(dataCheckTable)
  ...
  useEffect(() => {
    setFilteredData(dataCheckTable)
  }, [dataCheckTable])
  ...
  const handleOnChange = (event: any) => {
    ...
    if (val === '') {
      ...
      const filtered = dataCheckTable?.filter((item: any) =>
        ...
        <CardHeader className='bg-[#eeefff]'>
          <CardTitle className='flex items-center justify-between'>
            ...
            <div className='w-1/2 flex items-center gap-1'>
              ...
              <AddEditModal
                setStatus={setStatus}
                formData={formCheckTable}
                setFormData={setformCheckTable}
                data={dataCheckTable}
                setData={setDataCheckTable}
                isStatus={isStatus}
